...
public class BsMemberCQ extends AbstractBsMemberCQ {
    ...
    public Map<String, MemberServiceCQ> xdfgetMemberId_ExistsReferrer_MemberServiceList() { return xgetSQueMap("memberId_ExistsReferrer_MemberServiceList"); }
    ...
    public Map<String, MemberServiceCQ> xdfgetMemberId_NotExistsReferrer_MemberServiceList() { return xgetSQueMap("memberId_NotExistsReferrer_MemberServiceList"); }
    ...
    public Map<String, MemberServiceCQ> xdfgetMemberId_SpecifyDerivedReferrer_MemberServiceList() { return xgetSQueMap("memberId_SpecifyDerivedReferrer_MemberServiceList"); }
    ...
    public Map<String, MemberServiceCQ> xdfgetMemberId_QueryDerivedReferrer_MemberServiceList() { return xgetSQueMap("memberId_QueryDerivedReferrer_MemberServiceList"); }
