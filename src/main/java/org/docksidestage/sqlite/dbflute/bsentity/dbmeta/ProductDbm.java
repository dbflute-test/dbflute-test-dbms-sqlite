...
public class ProductDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignProductStatus() {
        ...
        return cfi("FK_PRODUCT_PRODUCT_STATUS_CODE_PRODUCT_STATUS", "productStatus", this, ProductStatusDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "productList");
    }
