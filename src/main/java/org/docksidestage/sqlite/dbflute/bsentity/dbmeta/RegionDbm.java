...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, null, Integer.class, "regionId", null, true, false, true, "INTEGER", 2000000000, 10, null, false, null, null, null, "memberAddressList", null, false);
    protected final ColumnInfo _columnRegionName = cci("REGION_NAME", "REGION_NAME", null, null, String.class, "regionName", null, false, false, true, "TEXT", 2000000000, 10, null, false, null, null, null, null, null, false);
    ...
    public ReferrerInfo referrerMemberAddressList() {
        ...
        return cri("FK_MEMBER_ADDRESS_REGION_ID_REGION", "memberAddressList", this, MemberAddressDbm.getInstance(), mp, false, "region");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlite.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.sqlite.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.sqlite.dbflute.exbhv.RegionBhv"; }
