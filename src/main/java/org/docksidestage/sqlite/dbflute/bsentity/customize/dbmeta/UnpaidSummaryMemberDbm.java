...
public class UnpaidSummaryMemberDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((UnpaidSummaryMember)et).getUnpaidPriceSummary(), (et, vl) -> ((UnpaidSummaryMember)et).setUnpaidPriceSummary((String)vl), "unpaidPriceSummary");
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlite.dbflute.exentity.customize.UnpaidSummaryMember"; }
