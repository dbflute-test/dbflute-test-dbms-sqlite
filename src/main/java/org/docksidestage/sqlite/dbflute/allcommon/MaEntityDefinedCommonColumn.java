...
public interface MaEntityDefinedCommonColumn extends Entity {
     ...
     */
    java.time.LocalDateTime getTableNameRegisterDatetime();

    /**
     * Set the value of tableNameRegisterDatetime.
     * @param tableNameRegisterDatetime The instance of the property type. (NullAllowed)
     */
    void setTableNameRegisterDatetime(java.time.LocalDateTime tableNameRegisterDatetime);
     ...
     * @return The instance of the property type. (NullAllowed)
     */
    java.time.LocalDateTime getTableNameUpdateDatetime();

    /**
     * Set the value of tableNameUpdateDatetime.
     * @param tableNameUpdateDatetime The instance of the property type. (NullAllowed)
     */
    void setTableNameUpdateDatetime(java.time.LocalDateTime tableNameUpdateDatetime);
