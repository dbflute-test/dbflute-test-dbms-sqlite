 ...
 */
public class RoyBsMemberAddressCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyMemberAddressCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsMemberAddressCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyMemberAddressCB acceptPK(Integer memberAddressId) {
        assertObjectNotNull("memberAddressId", memberAddressId);
        RoyBsMemberAddressCB cb = this;
        cb.query().setMemberAddressId_Equal(memberAddressId);
        return (RoyMemberAddressCB)this;
    }
     ...
     */
    public RoyMemberAddressCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public RoyMemberAddressCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyMemberAddressCQ doGetConditionQuery() {
    ...
    protected RoyMemberAddressCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyMemberAddressCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyMemberAddressCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyMemberAddressCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyMemberAddressCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyMemberAddressCB> unionCBLambda) {
        final RoyMemberAddressCB cb = new RoyMemberAddressCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberAddressCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyMemberAddressCB> unionCBLambda) {
        final RoyMemberAddressCB cb = new RoyMemberAddressCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberAddressCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyMemberAddressCQ> {
        protected RoyMemberCB.HpSpecification _member;
        protected RoyRegionCB.HpSpecification _region;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyMemberAddressCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryRegion()
                    || qyCall().qy().xgetReferrerQuery() instanceof RoyRegionCQ) {
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public RoyRegionCB.HpSpecification specifyRegion() {
            assertRelation("region");
            if (_region == null) {
                _region = new RoyRegionCB.HpSpecification(_baseCB
         ...
         */
        public HpSDRFunction<RoyMemberAddressCB, RoyMemberAddressCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberAddressCB> sq, RoyMemberAddressCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyMemberAddressCB dreamCruiseCB() {
        RoyMemberAddressCB cb = new RoyMemberAddressCB();
        cb.xsetupForDreamCruise((RoyMemberAddressCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyMemberAddressCB> columnQuery(final SpecifyQuery<RoyMemberAddressCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyMemberAddressCB xcreateColumnQueryCB() {
        RoyMemberAddressCB cb = new RoyMemberAddressCB();
        cb.xsetupForColumnQuery((RoyMemberAddressCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyMemberAddressCB> orCBLambda) {
        xorSQ((RoyMemberAddressCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyMemberAddressCB> andCBLambda) {
        xorSQAP((RoyMemberAddressCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyMemberAddressCB cb;
        if (mainCB != null) {
            cb = (RoyMemberAddressCB)mainCB;
        } else {
            cb = new RoyMemberAddressCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyMemberAddressCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyMemberAddressCQ.class.getName(); }
