 ...
 */
public abstract class RoyAbstractBsSummaryProductCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyAbstractBsSummaryProductCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public abstract String keepProductId_ExistsReferrer_PurchaseList(RoyPurchaseCQ sq);
    ...
    public abstract String keepProductId_NotExistsReferrer_PurchaseList(RoyPurchaseCQ sq);
    ...
    public abstract String keepProductId_SpecifyDerivedReferrer_PurchaseList(RoyPurchaseCQ sq);
    ...
    public abstract String keepProductId_QueryDerivedReferrer_PurchaseList(RoyPurchaseCQ sq);
     ...
     */
    public HpSLCFunction<RoySummaryProductCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, RoySummaryProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoySummaryProductCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, RoySummaryProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoySummaryProductCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, RoySummaryProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoySummaryProductCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, RoySummaryProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoySummaryProductCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, RoySummaryProductCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;RoySummaryProductCB&gt;() {
     *     public void query(RoySummaryProductCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoySummaryProductCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, RoySummaryProductCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        RoySummaryProductCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(RoySummaryProductCQ sq);

    protected RoySummaryProductCB xcreateScalarConditionCB() {
        RoySummaryProductCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected RoySummaryProductCB xcreateScalarConditionPartitionByCB() {
        RoySummaryProductCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<RoySummaryProductCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(RoySummaryProductCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<RoySummaryProductCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(RoySummaryProductCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        RoySummaryProductCB cb = new RoySummaryProductCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(RoySummaryProductCQ sq);
     ...
     */
    public void myselfExists(SubQuery<RoySummaryProductCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        RoySummaryProductCB cb = new RoySummaryProductCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(RoySummaryProductCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected RoySummaryProductCB newMyCB() {
        return new RoySummaryProductCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return RoySummaryProductCQ.class.getName(); }
