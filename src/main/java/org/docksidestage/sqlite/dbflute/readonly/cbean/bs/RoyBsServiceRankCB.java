 ...
 */
public class RoyBsServiceRankCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyServiceRankCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsServiceRankCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyServiceRankCB acceptPK(String serviceRankCode) {
        assertObjectNotNull("serviceRankCode", serviceRankCode);
        RoyBsServiceRankCB cb = this;
        cb.query().setServiceRankCode_Equal(serviceRankCode);
        return (RoyServiceRankCB)this;
    }
     ...
     */
    public RoyServiceRankCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public RoyServiceRankCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyServiceRankCQ doGetConditionQuery() {
    ...
    protected RoyServiceRankCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyServiceRankCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyServiceRankCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyServiceRankCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyServiceRankCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyServiceRankCB> unionCBLambda) {
        final RoyServiceRankCB cb = new RoyServiceRankCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyServiceRankCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyServiceRankCB> unionCBLambda) {
        final RoyServiceRankCB cb = new RoyServiceRankCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyServiceRankCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyServiceRankCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyServiceRankCQ> qyCall
         ...
         */
        public HpSDRFunction<RoyMemberServiceCB, RoyServiceRankCQ> derivedMemberService() {
            assertDerived("memberServiceList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberServiceCB> sq, RoyServiceRankCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<RoyServiceRankCB, RoyServiceRankCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyServiceRankCB> sq, RoyServiceRankCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyServiceRankCB dreamCruiseCB() {
        RoyServiceRankCB cb = new RoyServiceRankCB();
        cb.xsetupForDreamCruise((RoyServiceRankCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyServiceRankCB> columnQuery(final SpecifyQuery<RoyServiceRankCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyServiceRankCB xcreateColumnQueryCB() {
        RoyServiceRankCB cb = new RoyServiceRankCB();
        cb.xsetupForColumnQuery((RoyServiceRankCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyServiceRankCB> orCBLambda) {
        xorSQ((RoyServiceRankCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyServiceRankCB> andCBLambda) {
        xorSQAP((RoyServiceRankCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyServiceRankCB cb;
        if (mainCB != null) {
            cb = (RoyServiceRankCB)mainCB;
        } else {
            cb = new RoyServiceRankCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyServiceRankCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyServiceRankCQ.class.getName(); }
