 ...
 */
public class RoyBsMemberWithdrawalCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyMemberWithdrawalCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsMemberWithdrawalCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyMemberWithdrawalCB acceptPK(Integer memberId) {
        assertObjectNotNull("memberId", memberId);
        RoyBsMemberWithdrawalCB cb = this;
        cb.query().setMemberId_Equal(memberId);
        return (RoyMemberWithdrawalCB)this;
    }
     ...
     */
    public RoyMemberWithdrawalCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public RoyMemberWithdrawalCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyMemberWithdrawalCQ doGetConditionQuery() {
    ...
    protected RoyMemberWithdrawalCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyMemberWithdrawalCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyMemberWithdrawalCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyMemberWithdrawalCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyMemberWithdrawalCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyMemberWithdrawalCB> unionCBLambda) {
        final RoyMemberWithdrawalCB cb = new RoyMemberWithdrawalCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberWithdrawalCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyMemberWithdrawalCB> unionCBLambda) {
        final RoyMemberWithdrawalCB cb = new RoyMemberWithdrawalCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberWithdrawalCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyMemberWithdrawalCQ> {
        protected RoyMemberCB.HpSpecification _member;
        protected RoyWithdrawalReasonCB.HpSpecification _withdrawalReason;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyMemberWithdrawalCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryWithdrawalReason()
                    || qyCall().qy().xgetReferrerQuery() instanceof RoyWithdrawalReasonCQ) {
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public RoyWithdrawalReasonCB.HpSpecification specifyWithdrawalReason() {
            assertRelation("withdrawalReason");
            if (_withdrawalReason == null) {
                _withdrawalReason = new RoyWithdrawalReasonCB.HpSpecification(_baseCB
         ...
         */
        public HpSDRFunction<RoyMemberWithdrawalCB, RoyMemberWithdrawalCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberWithdrawalCB> sq, RoyMemberWithdrawalCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyMemberWithdrawalCB dreamCruiseCB() {
        RoyMemberWithdrawalCB cb = new RoyMemberWithdrawalCB();
        cb.xsetupForDreamCruise((RoyMemberWithdrawalCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyMemberWithdrawalCB> columnQuery(final SpecifyQuery<RoyMemberWithdrawalCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyMemberWithdrawalCB xcreateColumnQueryCB() {
        RoyMemberWithdrawalCB cb = new RoyMemberWithdrawalCB();
        cb.xsetupForColumnQuery((RoyMemberWithdrawalCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyMemberWithdrawalCB> orCBLambda) {
        xorSQ((RoyMemberWithdrawalCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyMemberWithdrawalCB> andCBLambda) {
        xorSQAP((RoyMemberWithdrawalCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyMemberWithdrawalCB cb;
        if (mainCB != null) {
            cb = (RoyMemberWithdrawalCB)mainCB;
        } else {
            cb = new RoyMemberWithdrawalCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyMemberWithdrawalCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyMemberWithdrawalCQ.class.getName(); }
