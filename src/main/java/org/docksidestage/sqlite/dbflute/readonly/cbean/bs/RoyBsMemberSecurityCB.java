 ...
 */
public class RoyBsMemberSecurityCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyMemberSecurityCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsMemberSecurityCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyMemberSecurityCB acceptPK(Integer memberId) {
        assertObjectNotNull("memberId", memberId);
        RoyBsMemberSecurityCB cb = this;
        cb.query().setMemberId_Equal(memberId);
        return (RoyMemberSecurityCB)this;
    }
     ...
     */
    public RoyMemberSecurityCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public RoyMemberSecurityCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyMemberSecurityCQ doGetConditionQuery() {
    ...
    protected RoyMemberSecurityCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyMemberSecurityCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyMemberSecurityCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyMemberSecurityCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyMemberSecurityCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyMemberSecurityCB> unionCBLambda) {
        final RoyMemberSecurityCB cb = new RoyMemberSecurityCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberSecurityCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyMemberSecurityCB> unionCBLambda) {
        final RoyMemberSecurityCB cb = new RoyMemberSecurityCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberSecurityCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyMemberSecurityCQ> {
        protected RoyMemberCB.HpSpecification _member;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyMemberSecurityCQ> qyCall
         ...
         */
        public HpSDRFunction<RoyMemberSecurityCB, RoyMemberSecurityCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberSecurityCB> sq, RoyMemberSecurityCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyMemberSecurityCB dreamCruiseCB() {
        RoyMemberSecurityCB cb = new RoyMemberSecurityCB();
        cb.xsetupForDreamCruise((RoyMemberSecurityCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyMemberSecurityCB> columnQuery(final SpecifyQuery<RoyMemberSecurityCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyMemberSecurityCB xcreateColumnQueryCB() {
        RoyMemberSecurityCB cb = new RoyMemberSecurityCB();
        cb.xsetupForColumnQuery((RoyMemberSecurityCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyMemberSecurityCB> orCBLambda) {
        xorSQ((RoyMemberSecurityCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyMemberSecurityCB> andCBLambda) {
        xorSQAP((RoyMemberSecurityCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyMemberSecurityCB cb;
        if (mainCB != null) {
            cb = (RoyMemberSecurityCB)mainCB;
        } else {
            cb = new RoyMemberSecurityCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyMemberSecurityCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyMemberSecurityCQ.class.getName(); }
