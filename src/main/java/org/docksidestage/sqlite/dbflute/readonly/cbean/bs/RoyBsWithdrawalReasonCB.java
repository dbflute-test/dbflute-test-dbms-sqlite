 ...
 */
public class RoyBsWithdrawalReasonCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyWithdrawalReasonCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsWithdrawalReasonCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyWithdrawalReasonCB acceptPK(String withdrawalReasonCode) {
        assertObjectNotNull("withdrawalReasonCode", withdrawalReasonCode);
        RoyBsWithdrawalReasonCB cb = this;
        cb.query().setWithdrawalReasonCode_Equal(withdrawalReasonCode);
        return (RoyWithdrawalReasonCB)this;
    }
     ...
     */
    public RoyWithdrawalReasonCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public RoyWithdrawalReasonCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyWithdrawalReasonCQ doGetConditionQuery() {
    ...
    protected RoyWithdrawalReasonCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyWithdrawalReasonCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyWithdrawalReasonCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyWithdrawalReasonCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyWithdrawalReasonCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyWithdrawalReasonCB> unionCBLambda) {
        final RoyWithdrawalReasonCB cb = new RoyWithdrawalReasonCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyWithdrawalReasonCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyWithdrawalReasonCB> unionCBLambda) {
        final RoyWithdrawalReasonCB cb = new RoyWithdrawalReasonCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyWithdrawalReasonCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyWithdrawalReasonCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyWithdrawalReasonCQ> qyCall
         ...
         * }, RoyMemberWithdrawal.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<RoyMemberWithdrawalCB, RoyWithdrawalReasonCQ> derivedMemberWithdrawal() {
            assertDerived("memberWithdrawalList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberWithdrawalCB> sq, RoyWithdrawalReasonCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<RoyWithdrawalReasonCB, RoyWithdrawalReasonCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyWithdrawalReasonCB> sq, RoyWithdrawalReasonCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyWithdrawalReasonCB dreamCruiseCB() {
        RoyWithdrawalReasonCB cb = new RoyWithdrawalReasonCB();
        cb.xsetupForDreamCruise((RoyWithdrawalReasonCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyWithdrawalReasonCB> columnQuery(final SpecifyQuery<RoyWithdrawalReasonCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyWithdrawalReasonCB xcreateColumnQueryCB() {
        RoyWithdrawalReasonCB cb = new RoyWithdrawalReasonCB();
        cb.xsetupForColumnQuery((RoyWithdrawalReasonCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyWithdrawalReasonCB> orCBLambda) {
        xorSQ((RoyWithdrawalReasonCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyWithdrawalReasonCB> andCBLambda) {
        xorSQAP((RoyWithdrawalReasonCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyWithdrawalReasonCB cb;
        if (mainCB != null) {
            cb = (RoyWithdrawalReasonCB)mainCB;
        } else {
            cb = new RoyWithdrawalReasonCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyWithdrawalReasonCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyWithdrawalReasonCQ.class.getName(); }
