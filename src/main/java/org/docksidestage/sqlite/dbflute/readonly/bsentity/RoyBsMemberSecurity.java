...
public abstract class RoyBsMemberSecurity extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof RoyBsMemberSecurity) {
            RoyBsMemberSecurity other = (RoyBsMemberSecurity)obj;
    ...
    @Override
    public RoyMemberSecurity clone() {
        return (RoyMemberSecurity)super.clone();
    }
