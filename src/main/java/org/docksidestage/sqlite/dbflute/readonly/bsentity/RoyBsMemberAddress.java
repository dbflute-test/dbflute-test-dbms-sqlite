 ...
 */
public abstract class RoyBsMemberAddress extends AbstractEntity implements DomainEntity {
    ...
    protected OptionalEntity<RoyRegion> _region;
     ...
     */
    public OptionalEntity<RoyRegion> getRegion() {
     ...
     */
    public void setRegion(OptionalEntity<RoyRegion> region) {
        _region = region;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof RoyBsMemberAddress) {
            RoyBsMemberAddress other = (RoyBsMemberAddress)obj;
    ...
    @Override
    public RoyMemberAddress clone() {
        return (RoyMemberAddress)super.clone();
    }
