...
/**
 * The base class for parameter-bean of SimpleMember.
 * @author DBFlute(AutoGenerator)
 */
public class RoyBsSimpleMemberPmb implements ParameterBean, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the parameter-bean of SimpleMember.
     */
    public RoyBsSimpleMemberPmb() {
    }
