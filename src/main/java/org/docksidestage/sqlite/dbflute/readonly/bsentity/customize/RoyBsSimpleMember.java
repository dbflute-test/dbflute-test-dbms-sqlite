 ...
 */
public abstract class RoyBsSimpleMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.sqlite.dbflute.readonly.bsentity.customize.dbmeta.RoySimpleMemberDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof RoyBsSimpleMember) {
            RoyBsSimpleMember other = (RoyBsSimpleMember)obj;
    ...
    @Override
    public RoySimpleMember clone() {
        return (RoySimpleMember)super.clone();
    }
