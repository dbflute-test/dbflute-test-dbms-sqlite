 ...
 */
public class RoyOptionMemberDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final RoyOptionMemberDbm _instance = new RoyOptionMemberDbm();
    private RoyOptionMemberDbm() {}
    public static RoyOptionMemberDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((RoyOptionMember)et).getMemberId(), (et, vl) -> ((RoyOptionMember)et).setMemberId((String)vl), "memberId");
        setupEpg(_epgMap, et -> ((RoyOptionMember)et).getMemberName(), (et, vl) -> ((RoyOptionMember)et).setMemberName((String)vl), "memberName");
        setupEpg(_epgMap, et -> ((RoyOptionMember)et).getBirthdate(), (et, vl) -> ((RoyOptionMember)et).setBirthdate((String)vl), "birthdate");
        setupEpg(_epgMap, et -> ((RoyOptionMember)et).getFormalizedDatetime(), (et, vl) -> ((RoyOptionMember)et).setFormalizedDatetime(ctldt(vl)), "formalizedDatetime");
        setupEpg(_epgMap, et -> ((RoyOptionMember)et).getMemberStatusCode(), (et, vl) -> ((RoyOptionMember)et).setMemberStatusCode((String)vl), "memberStatusCode");
        ...
        setupEpg(_epgMap, et -> ((RoyOptionMember)et).getDummyFlg(), (et, vl) -> {
            ...
            if (cls != null) {
                ...
                ((RoyOptionMember)et).mynativeMappingDummyFlg((String)vl);
            }
        }, "dummyFlg");
        setupEpg(_epgMap, et -> ((RoyOptionMember)et).getDummyNoflg(), (et, vl) -> ((RoyOptionMember)et).setDummyNoflg((String)vl), "dummyNoflg");
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, null, String.class, "memberId", null, false, false, false, "null", 2147483647, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnBirthdate = cci("BIRTHDATE", "BIRTHDATE", null, null, String.class, "birthdate", null, false, false, false, "null", 2147483647, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnMemberStatusCode = cci("MEMBER_STATUS_CODE", "MEMBER_STATUS_CODE", null, null, String.class, "memberStatusCode", null, false, false, false, "null", 2147483647, 0, null, null, false, null, null, null, null, RoyCDef.DefMeta.MemberStatus, false);
    ...
    protected final ColumnInfo _columnStatusDisplayOrder = cci("STATUS_DISPLAY_ORDER", "STATUS_DISPLAY_ORDER", null, null, String.class, "statusDisplayOrder", null, false, false, false, "null", 2147483647, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnDummyFlg = cci("DUMMY_FLG", "DUMMY_FLG", null, null, String.class, "dummyFlg", null, false, false, false, "null", 2147483647, 0, null, null, false, null, null, null, null, RoyCDef.DefMeta.Flg, false);
    protected final ColumnInfo _columnDummyNoflg = cci("DUMMY_NOFLG", "DUMMY_NOFLG", null, null, String.class, "dummyNoflg", null, false, false, false, "null", 2147483647, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlite.dbflute.readonly.exentity.customize.RoyOptionMember"; }
    ...
    //                                                                         Object Type
    //                                                                         ===========
    public Class<RoyOptionMember> getEntityType() { return RoyOptionMember.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public RoyOptionMember newEntity() { return new RoyOptionMember(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((RoyOptionMember)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((RoyOptionMember)et, mp); }
