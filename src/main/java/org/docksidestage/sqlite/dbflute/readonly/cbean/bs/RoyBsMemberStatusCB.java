 ...
 */
public class RoyBsMemberStatusCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyMemberStatusCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsMemberStatusCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyMemberStatusCB acceptPK(String memberStatusCode) {
        assertObjectNotNull("memberStatusCode", memberStatusCode);
        RoyBsMemberStatusCB cb = this;
        cb.query().setMemberStatusCode_Equal(memberStatusCode);
        return (RoyMemberStatusCB)this;
    }
     ...
     */
    public RoyMemberStatusCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public RoyMemberStatusCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyMemberStatusCQ doGetConditionQuery() {
    ...
    protected RoyMemberStatusCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyMemberStatusCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyMemberStatusCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyMemberStatusCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyMemberStatusCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyMemberStatusCB> unionCBLambda) {
        final RoyMemberStatusCB cb = new RoyMemberStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberStatusCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyMemberStatusCB> unionCBLambda) {
        final RoyMemberStatusCB cb = new RoyMemberStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberStatusCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyMemberStatusCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyMemberStatusCQ> qyCall
         ...
         * }, RoyMember.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<RoyMemberCB, RoyMemberStatusCQ> derivedMember() {
            assertDerived("memberList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberCB> sq, RoyMemberStatusCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<RoyMemberLoginCB, RoyMemberStatusCQ> derivedMemberLogin() {
            assertDerived("memberLoginList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberLoginCB> sq, RoyMemberStatusCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<RoyMemberStatusCB, RoyMemberStatusCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberStatusCB> sq, RoyMemberStatusCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyMemberStatusCB dreamCruiseCB() {
        RoyMemberStatusCB cb = new RoyMemberStatusCB();
        cb.xsetupForDreamCruise((RoyMemberStatusCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyMemberStatusCB> columnQuery(final SpecifyQuery<RoyMemberStatusCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyMemberStatusCB xcreateColumnQueryCB() {
        RoyMemberStatusCB cb = new RoyMemberStatusCB();
        cb.xsetupForColumnQuery((RoyMemberStatusCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyMemberStatusCB> orCBLambda) {
        xorSQ((RoyMemberStatusCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyMemberStatusCB> andCBLambda) {
        xorSQAP((RoyMemberStatusCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyMemberStatusCB cb;
        if (mainCB != null) {
            cb = (RoyMemberStatusCB)mainCB;
        } else {
            cb = new RoyMemberStatusCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyMemberStatusCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyMemberStatusCQ.class.getName(); }
