 ...
 */
public class RoyImplementedInvokerAssistant implements InvokerAssistant {
    ...
    protected RoyDBFluteInitializer _introduction;
    ...
    public DBDef assistCurrentDBDef() {
        return RoyDBCurrent.getInstance().currentDBDef();
    }
    ...
    public DataSource assistDataSource() { // DI component
        ...
        DataSourceHandler handler = RoyDBFluteConfig.getInstance().getDataSourceHandler();
    ...
    protected RoyImplementedSqlClauseCreator newImplementedSqlClauseCreator() {
        return new RoyImplementedSqlClauseCreator();
    }
    ...
    protected StatementFactory createStatementFactory() {
        ...
        RoyDBFluteConfig config = RoyDBFluteConfig.getInstance();
    ...
    protected TnBeanMetaDataFactory createBeanMetaDataFactory() {
        ...
        factory.setInternalDebug(RoyDBFluteConfig.getInstance().isInternalDebug());
        return factory;
    }
    ...
    protected OutsideSqlExecutorFactory createOutsideSqlExecutorFactory() {
        OutsideSqlExecutorFactory factory = RoyDBFluteConfig.getInstance().getOutsideSqlExecutorFactory();
        if (factory != null) {
            return factory;
        }
    ...
    protected SQLExceptionDigger createSQLExceptionDigger() {
        return RoyDBFluteConfig.getInstance().getSQLExceptionDigger();
    }
    ...
    protected SequenceCacheHandler createSequenceCacheHandler() {
        ...
        SequenceCacheKeyGenerator generator = RoyDBFluteConfig.getInstance().getSequenceCacheKeyGenerator();
        if (generator != null) {
            handler.setSequenceCacheKeyGenerator(generator);
        }
        handler.setInternalDebug(RoyDBFluteConfig.getInstance().isInternalDebug());
        return handler;
    }
    ...
    public StatementConfig assistDefaultStatementConfig() {
        return RoyDBFluteConfig.getInstance().getDefaultStatementConfig();
    }
    ...
    public GearedCipherManager assistGearedCipherManager() {
        return RoyDBFluteConfig.getInstance().getGearedCipherManager();
    }
    ...
    @Resource
    public void setIntroduction(RoyDBFluteInitializer introduction) {
