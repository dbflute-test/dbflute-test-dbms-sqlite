...
public abstract class RoyBsPurchasePayment extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof RoyBsPurchasePayment) {
            RoyBsPurchasePayment other = (RoyBsPurchasePayment)obj;
    ...
    @Override
    public RoyPurchasePayment clone() {
        return (RoyPurchasePayment)super.clone();
    }
