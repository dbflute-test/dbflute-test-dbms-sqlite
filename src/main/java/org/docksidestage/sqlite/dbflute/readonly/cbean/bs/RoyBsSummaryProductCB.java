 ...
 */
public class RoyBsSummaryProductCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoySummaryProductCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsSummaryProductCB() {
     ...
     * @return this. (NotNull)
     */
    public RoySummaryProductCB acceptPK(Integer productId) {
        assertObjectNotNull("productId", productId);
        RoyBsSummaryProductCB cb = this;
        cb.query().setProductId_Equal(productId);
        return (RoySummaryProductCB)this;
    }
     ...
     */
    public RoySummaryProductCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public RoySummaryProductCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoySummaryProductCQ doGetConditionQuery() {
    ...
    protected RoySummaryProductCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoySummaryProductCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoySummaryProductCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoySummaryProductCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoySummaryProductCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoySummaryProductCB> unionCBLambda) {
        final RoySummaryProductCB cb = new RoySummaryProductCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoySummaryProductCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoySummaryProductCB> unionCBLambda) {
        final RoySummaryProductCB cb = new RoySummaryProductCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoySummaryProductCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoySummaryProductCQ> {
        protected RoyProductStatusCB.HpSpecification _productStatus;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoySummaryProductCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryProductStatus()
                    || qyCall().qy().xgetReferrerQuery() instanceof RoyProductStatusCQ) {
         ...
         */
        public RoyProductStatusCB.HpSpecification specifyProductStatus() {
            assertRelation("productStatus");
            if (_productStatus == null) {
                _productStatus = new RoyProductStatusCB.HpSpecification(_baseCB
         ...
         */
        public HpSDRFunction<RoyPurchaseCB, RoySummaryProductCQ> derivedPurchase() {
            assertDerived("purchaseList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyPurchaseCB> sq, RoySummaryProductCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<RoySummaryProductCB, RoySummaryProductCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoySummaryProductCB> sq, RoySummaryProductCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoySummaryProductCB dreamCruiseCB() {
        RoySummaryProductCB cb = new RoySummaryProductCB();
        cb.xsetupForDreamCruise((RoySummaryProductCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoySummaryProductCB> columnQuery(final SpecifyQuery<RoySummaryProductCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoySummaryProductCB xcreateColumnQueryCB() {
        RoySummaryProductCB cb = new RoySummaryProductCB();
        cb.xsetupForColumnQuery((RoySummaryProductCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoySummaryProductCB> orCBLambda) {
        xorSQ((RoySummaryProductCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoySummaryProductCB> andCBLambda) {
        xorSQAP((RoySummaryProductCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoySummaryProductCB cb;
        if (mainCB != null) {
            cb = (RoySummaryProductCB)mainCB;
        } else {
            cb = new RoySummaryProductCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoySummaryProductCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoySummaryProductCQ.class.getName(); }
