 ...
 */
public abstract class RoyAbstractBsProductCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyAbstractBsProductCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * PRODUCT_NAME: {NotNull, TEXT(2000000000, 10)} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PRODUCT_HANDLE_CODE: {NotNull, TEXT(2000000000, 10)} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PRODUCT_STATUS_CODE: {NotNull, TEXT(2000000000, 10), FK to PRODUCT_STATUS} <br>
     ...
     */
    public HpSLCFunction<RoyProductCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, RoyProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyProductCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, RoyProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyProductCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, RoyProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyProductCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, RoyProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyProductCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, RoyProductCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;RoyProductCB&gt;() {
     *     public void query(RoyProductCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyProductCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, RoyProductCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyProductCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(RoyProductCQ sq);

    protected RoyProductCB xcreateScalarConditionCB() {
        RoyProductCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected RoyProductCB xcreateScalarConditionPartitionByCB() {
        RoyProductCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<RoyProductCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(RoyProductCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<RoyProductCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(RoyProductCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyProductCB cb = new RoyProductCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(RoyProductCQ sq);
     ...
     */
    public void myselfExists(SubQuery<RoyProductCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        RoyProductCB cb = new RoyProductCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(RoyProductCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected RoyProductCB newMyCB() {
        return new RoyProductCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return RoyProductCQ.class.getName(); }
