 ...
 */
public class RoyBsPurchasePaymentCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyPurchasePaymentCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsPurchasePaymentCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyPurchasePaymentCB acceptPK(Integer purchasePaymentId) {
        assertObjectNotNull("purchasePaymentId", purchasePaymentId);
        RoyBsPurchasePaymentCB cb = this;
        cb.query().setPurchasePaymentId_Equal(purchasePaymentId);
        return (RoyPurchasePaymentCB)this;
    }
     ...
     */
    public RoyPurchasePaymentCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public RoyPurchasePaymentCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyPurchasePaymentCQ doGetConditionQuery() {
    ...
    protected RoyPurchasePaymentCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyPurchasePaymentCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyPurchasePaymentCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyPurchasePaymentCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyPurchasePaymentCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyPurchasePaymentCB> unionCBLambda) {
        final RoyPurchasePaymentCB cb = new RoyPurchasePaymentCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyPurchasePaymentCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyPurchasePaymentCB> unionCBLambda) {
        final RoyPurchasePaymentCB cb = new RoyPurchasePaymentCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyPurchasePaymentCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyPurchasePaymentCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyPurchasePaymentCQ> qyCall
         ...
         */
        public HpSDRFunction<RoyPurchasePaymentCB, RoyPurchasePaymentCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyPurchasePaymentCB> sq, RoyPurchasePaymentCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyPurchasePaymentCB dreamCruiseCB() {
        RoyPurchasePaymentCB cb = new RoyPurchasePaymentCB();
        cb.xsetupForDreamCruise((RoyPurchasePaymentCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyPurchasePaymentCB> columnQuery(final SpecifyQuery<RoyPurchasePaymentCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyPurchasePaymentCB xcreateColumnQueryCB() {
        RoyPurchasePaymentCB cb = new RoyPurchasePaymentCB();
        cb.xsetupForColumnQuery((RoyPurchasePaymentCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyPurchasePaymentCB> orCBLambda) {
        xorSQ((RoyPurchasePaymentCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyPurchasePaymentCB> andCBLambda) {
        xorSQAP((RoyPurchasePaymentCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyPurchasePaymentCB cb;
        if (mainCB != null) {
            cb = (RoyPurchasePaymentCB)mainCB;
        } else {
            cb = new RoyPurchasePaymentCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyPurchasePaymentCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyPurchasePaymentCQ.class.getName(); }
