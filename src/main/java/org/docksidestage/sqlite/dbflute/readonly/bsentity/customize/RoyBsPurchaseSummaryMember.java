 ...
 */
public abstract class RoyBsPurchaseSummaryMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.sqlite.dbflute.readonly.bsentity.customize.dbmeta.RoyPurchaseSummaryMemberDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof RoyBsPurchaseSummaryMember) {
            RoyBsPurchaseSummaryMember other = (RoyBsPurchaseSummaryMember)obj;
    ...
    @Override
    public RoyPurchaseSummaryMember clone() {
        return (RoyPurchaseSummaryMember)super.clone();
    }
