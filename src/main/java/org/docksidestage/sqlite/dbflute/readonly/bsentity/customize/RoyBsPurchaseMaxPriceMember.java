 ...
 */
public abstract class RoyBsPurchaseMaxPriceMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.sqlite.dbflute.readonly.bsentity.customize.dbmeta.RoyPurchaseMaxPriceMemberDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof RoyBsPurchaseMaxPriceMember) {
            RoyBsPurchaseMaxPriceMember other = (RoyBsPurchaseMaxPriceMember)obj;
    ...
    @Override
    public RoyPurchaseMaxPriceMember clone() {
        return (RoyPurchaseMaxPriceMember)super.clone();
    }
