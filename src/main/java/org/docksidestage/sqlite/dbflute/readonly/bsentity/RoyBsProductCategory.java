...
public abstract class RoyBsProductCategory extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof RoyBsProductCategory) {
            RoyBsProductCategory other = (RoyBsProductCategory)obj;
    ...
    @Override
    public RoyProductCategory clone() {
        return (RoyProductCategory)super.clone();
    }
