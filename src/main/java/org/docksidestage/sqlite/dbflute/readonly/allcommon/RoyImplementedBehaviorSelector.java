 ...
 */
public class RoyImplementedBehaviorSelector implements BehaviorSelector {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(RoyImplementedBehaviorSelector.class);
    ...
    public void initializeConditionBeanMetaData() {
        final Map<String, DBMeta> dbmetaMap = RoyDBMetaInstanceHandler.getUnmodifiableDBMetaMap();
    ...
    public BehaviorReadable byName(String tableFlexibleName) {
        ...
        final DBMeta dbmeta = RoyDBMetaInstanceHandler.findDBMeta(tableFlexibleName);
