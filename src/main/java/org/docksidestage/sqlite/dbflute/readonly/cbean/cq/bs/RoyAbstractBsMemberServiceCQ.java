 ...
 */
public abstract class RoyAbstractBsMemberServiceCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyAbstractBsMemberServiceCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<RoyMemberServiceCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, RoyMemberServiceCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberServiceCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, RoyMemberServiceCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberServiceCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, RoyMemberServiceCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberServiceCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, RoyMemberServiceCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberServiceCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, RoyMemberServiceCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;RoyMemberServiceCB&gt;() {
     *     public void query(RoyMemberServiceCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberServiceCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, RoyMemberServiceCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberServiceCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(RoyMemberServiceCQ sq);

    protected RoyMemberServiceCB xcreateScalarConditionCB() {
        RoyMemberServiceCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected RoyMemberServiceCB xcreateScalarConditionPartitionByCB() {
        RoyMemberServiceCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<RoyMemberServiceCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(RoyMemberServiceCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<RoyMemberServiceCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(RoyMemberServiceCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberServiceCB cb = new RoyMemberServiceCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_SERVICE_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(RoyMemberServiceCQ sq);
     ...
     */
    public void myselfExists(SubQuery<RoyMemberServiceCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        RoyMemberServiceCB cb = new RoyMemberServiceCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(RoyMemberServiceCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected RoyMemberServiceCB newMyCB() {
        return new RoyMemberServiceCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return RoyMemberServiceCQ.class.getName(); }
