 ...
 */
public class RoyDBFluteConfig {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(RoyDBFluteConfig.class);

    /** Singleton instance. */
    private static final RoyDBFluteConfig _instance = new RoyDBFluteConfig();
     ...
     * Constructor.
     */
    private RoyDBFluteConfig() { // adjusts default settings
     ...
     */
    public static RoyDBFluteConfig getInstance() {
        return _instance;
    }
