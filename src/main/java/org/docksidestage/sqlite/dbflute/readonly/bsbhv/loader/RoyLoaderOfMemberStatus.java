...
public class RoyLoaderOfMemberStatus {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected List<RoyMemberStatus> _selectedList;
    protected BehaviorSelector _selector;
    protected RoyMemberStatusBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public RoyLoaderOfMemberStatus ready(List<RoyMemberStatus> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected RoyMemberStatusBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(RoyMemberStatusBhv.class); return _myBhv; } }

    // ===================================================================================
    //                                                                       Load Referrer
    //                                                                       =============
    protected List<RoyMember> _referrerMember;
     ...
     * });
     * for (RoyMemberStatus memberStatus : <span style="color: #553000">memberStatusList</span>) {
     ...
     */
    public NestedReferrerLoaderGateway<RoyLoaderOfMember> loadMember(ReferrerConditionSetupper<RoyMemberCB> refCBLambda) {
        myBhv().loadMember(_selectedList, refCBLambda).withNestedReferrer(refLs -> _referrerMember = refLs);
        return hd -> hd.handle(new RoyLoaderOfMember().ready(_referrerMember, _selector));
    }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<RoyMemberStatus> getSelectedList() { return _selectedList; }
