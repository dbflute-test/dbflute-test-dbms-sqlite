 ...
 */
public abstract class RoyAbstractBsMemberWithdrawalCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyAbstractBsMemberWithdrawalCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * WITHDRAWAL_REASON_CODE: {TEXT(2000000000, 10), FK to WITHDRAWAL_REASON} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * WITHDRAWAL_REASON_INPUT_TEXT: {TEXT(2000000000, 10)} <br>
     ...
     * WITHDRAWAL_DATETIME: {NotNull, DATETIME(2000000000, 10)}
     * @param withdrawalDatetimeList The collection of withdrawalDatetime as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setWithdrawalDatetime_InScope(Collection<java.time.LocalDateTime> withdrawalDatetimeList) {
        doSetWithdrawalDatetime_InScope(withdrawalDatetimeList);
    }

    protected void doSetWithdrawalDatetime_InScope(Collection<java.time.LocalDateTime> withdrawalDatetimeList) {
     ...
     * WITHDRAWAL_DATETIME: {NotNull, DATETIME(2000000000, 10)}
     * @param withdrawalDatetimeList The collection of withdrawalDatetime as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setWithdrawalDatetime_NotInScope(Collection<java.time.LocalDateTime> withdrawalDatetimeList) {
        doSetWithdrawalDatetime_NotInScope(withdrawalDatetimeList);
    }

    protected void doSetWithdrawalDatetime_NotInScope(Collection<java.time.LocalDateTime> withdrawalDatetimeList) {
     ...
     */
    public HpSLCFunction<RoyMemberWithdrawalCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, RoyMemberWithdrawalCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberWithdrawalCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, RoyMemberWithdrawalCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberWithdrawalCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, RoyMemberWithdrawalCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberWithdrawalCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, RoyMemberWithdrawalCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberWithdrawalCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, RoyMemberWithdrawalCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;RoyMemberWithdrawalCB&gt;() {
     *     public void query(RoyMemberWithdrawalCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberWithdrawalCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, RoyMemberWithdrawalCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberWithdrawalCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(RoyMemberWithdrawalCQ sq);

    protected RoyMemberWithdrawalCB xcreateScalarConditionCB() {
        RoyMemberWithdrawalCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected RoyMemberWithdrawalCB xcreateScalarConditionPartitionByCB() {
        RoyMemberWithdrawalCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<RoyMemberWithdrawalCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(RoyMemberWithdrawalCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<RoyMemberWithdrawalCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(RoyMemberWithdrawalCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberWithdrawalCB cb = new RoyMemberWithdrawalCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(RoyMemberWithdrawalCQ sq);
     ...
     */
    public void myselfExists(SubQuery<RoyMemberWithdrawalCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        RoyMemberWithdrawalCB cb = new RoyMemberWithdrawalCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(RoyMemberWithdrawalCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected RoyMemberWithdrawalCB newMyCB() {
        return new RoyMemberWithdrawalCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return RoyMemberWithdrawalCQ.class.getName(); }
