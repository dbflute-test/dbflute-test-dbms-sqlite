 ...
 */
public abstract class RoyBsPurchase extends AbstractEntity implements DomainEntity {
     ...
     */
    public void setPaymentCompleteFlgAsFlg(RoyCDef.Flg cdef) {
    ...
    public void setPaymentCompleteFlg_True() {
        setPaymentCompleteFlgAsFlg(RoyCDef.Flg.True);
    }
    ...
    public void setPaymentCompleteFlg_False() {
        setPaymentCompleteFlgAsFlg(RoyCDef.Flg.False);
    }
    ...
    public boolean isPaymentCompleteFlgTrue() {
        RoyCDef.Flg cdef = getPaymentCompleteFlgAsFlg();
    ...
    protected OptionalEntity<RoyProduct> _product;
     ...
     */
    public OptionalEntity<RoyProduct> getProduct() {
     ...
     */
    public void setProduct(OptionalEntity<RoyProduct> product) {
        _product = product;
    }

    /** SUMMARY_PRODUCT by my PRODUCT_ID, named 'summaryProduct'. */
    protected OptionalEntity<RoySummaryProduct> _summaryProduct;
     ...
     */
    public OptionalEntity<RoySummaryProduct> getSummaryProduct() {
     ...
     */
    public void setSummaryProduct(OptionalEntity<RoySummaryProduct> summaryProduct) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof RoyBsPurchase) {
            RoyBsPurchase other = (RoyBsPurchase)obj;
    ...
    @Override
    public RoyPurchase clone() {
        return (RoyPurchase)super.clone();
    }
    ...
    protected void setPaymentCompleteFlg(Integer paymentCompleteFlg) {
        checkClassificationCode("PAYMENT_COMPLETE_FLG", RoyCDef.DefMeta.Flg, paymentCompleteFlg);
