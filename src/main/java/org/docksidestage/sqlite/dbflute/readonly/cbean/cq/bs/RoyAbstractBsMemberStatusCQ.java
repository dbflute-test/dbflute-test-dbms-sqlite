 ...
 */
public abstract class RoyAbstractBsMemberStatusCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyAbstractBsMemberStatusCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void existsMember(SubQuery<RoyMemberCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        RoyMemberCB cb = new RoyMemberCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepMemberStatusCode_ExistsReferrer_MemberList(RoyMemberCQ sq);
    ...
    public abstract String keepMemberStatusCode_ExistsReferrer_MemberLoginList(RoyMemberLoginCQ sq);
     ...
     */
    public void notExistsMember(SubQuery<RoyMemberCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        RoyMemberCB cb = new RoyMemberCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepMemberStatusCode_NotExistsReferrer_MemberList(RoyMemberCQ sq);
    ...
    public abstract String keepMemberStatusCode_NotExistsReferrer_MemberLoginList(RoyMemberLoginCQ sq);

    public void xsderiveMemberList(String fn, SubQuery<RoyMemberCB> sq, String al, DerivedReferrerOption op) {
    ...
    public abstract String keepMemberStatusCode_SpecifyDerivedReferrer_MemberList(RoyMemberCQ sq);
    ...
    public abstract String keepMemberStatusCode_SpecifyDerivedReferrer_MemberLoginList(RoyMemberLoginCQ sq);
     ...
     */
    public HpQDRFunction<RoyMemberCB> derivedMember() {
        return xcreateQDRFunctionMemberList();
    }
    protected HpQDRFunction<RoyMemberCB> xcreateQDRFunctionMemberList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveMemberList(fn, sq, rd, vl, op));
    }
    public void xqderiveMemberList(String fn, SubQuery<RoyMemberCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberCB cb = new RoyMemberCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_MemberList(RoyMemberCQ sq);
    ...
    public abstract String keepMemberStatusCode_QueryDerivedReferrer_MemberLoginList(RoyMemberLoginCQ sq);
     ...
     * MEMBER_STATUS_NAME: {NotNull, TEXT(2000000000, 10)} <br>
     ...
     */
    public HpSLCFunction<RoyMemberStatusCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, RoyMemberStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberStatusCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, RoyMemberStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberStatusCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, RoyMemberStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberStatusCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, RoyMemberStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberStatusCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, RoyMemberStatusCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;RoyMemberStatusCB&gt;() {
     *     public void query(RoyMemberStatusCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberStatusCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, RoyMemberStatusCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberStatusCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(RoyMemberStatusCQ sq);

    protected RoyMemberStatusCB xcreateScalarConditionCB() {
        RoyMemberStatusCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected RoyMemberStatusCB xcreateScalarConditionPartitionByCB() {
        RoyMemberStatusCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<RoyMemberStatusCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberStatusCB cb = new RoyMemberStatusCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "MEMBER_STATUS_CODE";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(RoyMemberStatusCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<RoyMemberStatusCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(RoyMemberStatusCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberStatusCB cb = new RoyMemberStatusCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_STATUS_CODE";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(RoyMemberStatusCQ sq);
     ...
     */
    public void myselfExists(SubQuery<RoyMemberStatusCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        RoyMemberStatusCB cb = new RoyMemberStatusCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(RoyMemberStatusCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected RoyMemberStatusCB newMyCB() {
        return new RoyMemberStatusCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return RoyMemberStatusCQ.class.getName(); }
