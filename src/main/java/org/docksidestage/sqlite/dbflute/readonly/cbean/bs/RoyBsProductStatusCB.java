 ...
 */
public class RoyBsProductStatusCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyProductStatusCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsProductStatusCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyProductStatusCB acceptPK(String productStatusCode) {
        assertObjectNotNull("productStatusCode", productStatusCode);
        RoyBsProductStatusCB cb = this;
        cb.query().setProductStatusCode_Equal(productStatusCode);
        return (RoyProductStatusCB)this;
    }
     ...
     */
    public RoyProductStatusCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public RoyProductStatusCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyProductStatusCQ doGetConditionQuery() {
    ...
    protected RoyProductStatusCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyProductStatusCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyProductStatusCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyProductStatusCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyProductStatusCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyProductStatusCB> unionCBLambda) {
        final RoyProductStatusCB cb = new RoyProductStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyProductStatusCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyProductStatusCB> unionCBLambda) {
        final RoyProductStatusCB cb = new RoyProductStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyProductStatusCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyProductStatusCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyProductStatusCQ> qyCall
         ...
         * }, RoyProduct.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<RoyProductCB, RoyProductStatusCQ> derivedProduct() {
            assertDerived("productList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyProductCB> sq, RoyProductStatusCQ cq, String al, DerivedReferrerOption op)
         ...
         *     productCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     productCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, RoySummaryProduct.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<RoySummaryProductCB, RoyProductStatusCQ> derivedSummaryProduct() {
            assertDerived("summaryProductList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoySummaryProductCB> sq, RoyProductStatusCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<RoyProductStatusCB, RoyProductStatusCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyProductStatusCB> sq, RoyProductStatusCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyProductStatusCB dreamCruiseCB() {
        RoyProductStatusCB cb = new RoyProductStatusCB();
        cb.xsetupForDreamCruise((RoyProductStatusCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyProductStatusCB> columnQuery(final SpecifyQuery<RoyProductStatusCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyProductStatusCB xcreateColumnQueryCB() {
        RoyProductStatusCB cb = new RoyProductStatusCB();
        cb.xsetupForColumnQuery((RoyProductStatusCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyProductStatusCB> orCBLambda) {
        xorSQ((RoyProductStatusCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyProductStatusCB> andCBLambda) {
        xorSQAP((RoyProductStatusCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyProductStatusCB cb;
        if (mainCB != null) {
            cb = (RoyProductStatusCB)mainCB;
        } else {
            cb = new RoyProductStatusCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyProductStatusCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyProductStatusCQ.class.getName(); }
