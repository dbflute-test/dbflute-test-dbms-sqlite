 ...
 */
public class RoyDBFluteInitializer {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(RoyDBFluteInitializer.class);
     ...
     * @return this. (NotNull)
     */
    public RoyDBFluteInitializer hookPrologue(PrologueHook prologueHook) {
    ...
    protected void standBy() {
        if (!RoyDBFluteConfig.getInstance().isLocked()) {
            RoyDBFluteConfig.getInstance().lock();
        }
