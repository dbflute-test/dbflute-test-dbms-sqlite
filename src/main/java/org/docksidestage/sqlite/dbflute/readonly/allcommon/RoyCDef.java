 ...
 */
public interface RoyCDef extends Classification {
     ...
     */
    public enum Flg implements RoyCDef {
        /** Yes: means valid */
        ...
        public ClassificationMeta meta() { return RoyCDef.DefMeta.Flg; }
    ...
    public enum MemberStatus implements RoyCDef {
        /** Provisional Member */
        ...
        public Set<String> sisterSet() { return _sisterSet; }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return RoyCDef.DefMeta.MemberStatus; }
    ...
    public enum DefMeta implements ClassificationMeta {
        ...
        public OptionalThing<? extends Classification> of(Object code) {
            if (Flg.name().equals(name())) { return RoyCDef.Flg.of(code); }
            if (MemberStatus.name().equals(name())) { return RoyCDef.MemberStatus.of(code); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public OptionalThing<? extends Classification> byName(String name) {
            if (Flg.name().equals(name())) { return RoyCDef.Flg.byName(name); }
            if (MemberStatus.name().equals(name())) { return RoyCDef.MemberStatus.byName(name); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public List<Classification> listAll() {
            if (Flg.name().equals(name())) { return toClassificationList(RoyCDef.Flg.listAll()); }
            if (MemberStatus.name().equals(name())) { return toClassificationList(RoyCDef.MemberStatus.listAll()); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> listByGroup(String groupName) { // exception if not found
            if (Flg.name().equals(name())) { return toClassificationList(RoyCDef.Flg.listByGroup(groupName)); }
            if (MemberStatus.name().equals(name())) { return toClassificationList(RoyCDef.MemberStatus.listByGroup(groupName)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<? extends Classification> listOf(Collection<String> codeList) {
            if (Flg.name().equals(name())) { return RoyCDef.Flg.listOf(codeList); }
            if (MemberStatus.name().equals(name())) { return RoyCDef.MemberStatus.listOf(codeList); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> groupOf(String groupName) { // old style
            if (Flg.name().equals(name())) { return toClassificationList(RoyCDef.Flg.groupOf(groupName)); }
            if (MemberStatus.name().equals(name())) { return toClassificationList(RoyCDef.MemberStatus.groupOf(groupName)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }
        ...
        public static OptionalThing<RoyCDef.DefMeta> find(String classificationName) { // instead of valueOf()
            if (classificationName == null) { throw new IllegalArgumentException("The argument 'classificationName' should not be null."); }
            if (Flg.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(RoyCDef.DefMeta.Flg); }
            if (MemberStatus.name().equalsIgnoreCase(classificationName)) { return OptionalThing.of(RoyCDef.DefMeta.MemberStatus); }
