...
public interface RoyCDef extends Classification {
    ...
    public enum DefMeta implements ClassificationMeta {
        /** general boolean classification for every flg-column */
        Flg(cd -> RoyCDef.Flg.of(cd), nm -> RoyCDef.Flg.byName(nm)
        , () -> RoyCDef.Flg.listAll(), gp -> RoyCDef.Flg.listByGroup(gp)
        , ClassificationCodeType.String, ClassificationUndefinedHandlingType.EXCEPTION),

        MemberStatus(cd -> RoyCDef.MemberStatus.of(cd), nm -> RoyCDef.MemberStatus.byName(nm)
        , () -> RoyCDef.MemberStatus.listAll(), gp -> RoyCDef.MemberStatus.listByGroup(gp)
    ...
    public static class ZzzoneSlimmer<CLS extends RoyCDef> {
