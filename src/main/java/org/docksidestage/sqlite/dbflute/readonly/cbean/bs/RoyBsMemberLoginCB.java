 ...
 */
public class RoyBsMemberLoginCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyMemberLoginCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsMemberLoginCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyMemberLoginCB acceptPK(Integer memberLoginId) {
        assertObjectNotNull("memberLoginId", memberLoginId);
        RoyBsMemberLoginCB cb = this;
        cb.query().setMemberLoginId_Equal(memberLoginId);
        return (RoyMemberLoginCB)this;
    }
     ...
     */
    public RoyMemberLoginCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public RoyMemberLoginCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyMemberLoginCQ doGetConditionQuery() {
    ...
    protected RoyMemberLoginCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyMemberLoginCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyMemberLoginCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyMemberLoginCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyMemberLoginCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyMemberLoginCB> unionCBLambda) {
        final RoyMemberLoginCB cb = new RoyMemberLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberLoginCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyMemberLoginCB> unionCBLambda) {
        final RoyMemberLoginCB cb = new RoyMemberLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberLoginCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyMemberLoginCQ> {
        protected RoyMemberStatusCB.HpSpecification _memberStatus;
        protected RoyMemberCB.HpSpecification _member;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyMemberLoginCQ> qyCall
         ...
         */
        public HpSDRFunction<RoyMemberLoginCB, RoyMemberLoginCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberLoginCB> sq, RoyMemberLoginCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyMemberLoginCB dreamCruiseCB() {
        RoyMemberLoginCB cb = new RoyMemberLoginCB();
        cb.xsetupForDreamCruise((RoyMemberLoginCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyMemberLoginCB> columnQuery(final SpecifyQuery<RoyMemberLoginCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyMemberLoginCB xcreateColumnQueryCB() {
        RoyMemberLoginCB cb = new RoyMemberLoginCB();
        cb.xsetupForColumnQuery((RoyMemberLoginCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyMemberLoginCB> orCBLambda) {
        xorSQ((RoyMemberLoginCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyMemberLoginCB> andCBLambda) {
        xorSQAP((RoyMemberLoginCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyMemberLoginCB cb;
        if (mainCB != null) {
            cb = (RoyMemberLoginCB)mainCB;
        } else {
            cb = new RoyMemberLoginCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyMemberLoginCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyMemberLoginCQ.class.getName(); }
