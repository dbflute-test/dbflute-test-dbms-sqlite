 ...
 */
public class RoyLoaderOfSummaryProduct {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<RoySummaryProduct> _selectedList;
    protected BehaviorSelector _selector;
    protected RoySummaryProductBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public RoyLoaderOfSummaryProduct ready(List<RoySummaryProduct> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected RoySummaryProductBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(RoySummaryProductBhv.class); return _myBhv; } }
     ...
     * });
     * for (RoySummaryProduct summaryProduct : <span style="color: #553000">summaryProductList</span>) {
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<RoySummaryProduct> getSelectedList() { return _selectedList; }
