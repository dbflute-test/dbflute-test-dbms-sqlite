 ...
 */
public abstract class RoyAbstractBsMemberSecurityCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyAbstractBsMemberSecurityCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * LOGIN_PASSWORD: {NotNull, TEXT(2000000000, 10)} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * REMINDER_QUESTION: {NotNull, TEXT(2000000000, 10)} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * REMINDER_ANSWER: {NotNull, TEXT(2000000000, 10)} <br>
     ...
     */
    public HpSLCFunction<RoyMemberSecurityCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, RoyMemberSecurityCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberSecurityCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, RoyMemberSecurityCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberSecurityCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, RoyMemberSecurityCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberSecurityCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, RoyMemberSecurityCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberSecurityCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, RoyMemberSecurityCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;RoyMemberSecurityCB&gt;() {
     *     public void query(RoyMemberSecurityCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<RoyMemberSecurityCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, RoyMemberSecurityCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberSecurityCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(RoyMemberSecurityCQ sq);

    protected RoyMemberSecurityCB xcreateScalarConditionCB() {
        RoyMemberSecurityCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected RoyMemberSecurityCB xcreateScalarConditionPartitionByCB() {
        RoyMemberSecurityCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<RoyMemberSecurityCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberSecurityCB cb = new RoyMemberSecurityCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "MEMBER_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(RoyMemberSecurityCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<RoyMemberSecurityCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(RoyMemberSecurityCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        RoyMemberSecurityCB cb = new RoyMemberSecurityCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(RoyMemberSecurityCQ sq);
     ...
     */
    public void myselfExists(SubQuery<RoyMemberSecurityCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        RoyMemberSecurityCB cb = new RoyMemberSecurityCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(RoyMemberSecurityCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected RoyMemberSecurityCB newMyCB() {
        return new RoyMemberSecurityCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return RoyMemberSecurityCQ.class.getName(); }
