 ...
 */
public class RoyBsMemberServiceCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected RoyMemberServiceCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public RoyBsMemberServiceCB() {
     ...
     * @return this. (NotNull)
     */
    public RoyMemberServiceCB acceptPK(Integer memberServiceId) {
        assertObjectNotNull("memberServiceId", memberServiceId);
        RoyBsMemberServiceCB cb = this;
        cb.query().setMemberServiceId_Equal(memberServiceId);
        return (RoyMemberServiceCB)this;
    }
     ...
     */
    public RoyMemberServiceCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public RoyMemberServiceCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RoyMemberServiceCQ doGetConditionQuery() {
    ...
    protected RoyMemberServiceCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RoyMemberServiceCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RoyMemberServiceCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RoyMemberServiceCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new RoyMemberServiceCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<RoyMemberServiceCB> unionCBLambda) {
        final RoyMemberServiceCB cb = new RoyMemberServiceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberServiceCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RoyMemberServiceCB> unionCBLambda) {
        final RoyMemberServiceCB cb = new RoyMemberServiceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RoyMemberServiceCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoyMemberServiceCQ> {
        protected RoyMemberCB.HpSpecification _member;
        protected RoyServiceRankCB.HpSpecification _serviceRank;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RoyMemberServiceCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryServiceRank()
                    || qyCall().qy().xgetReferrerQuery() instanceof RoyServiceRankCQ) {
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public RoyServiceRankCB.HpSpecification specifyServiceRank() {
            assertRelation("serviceRank");
            if (_serviceRank == null) {
                _serviceRank = new RoyServiceRankCB.HpSpecification(_baseCB
         ...
         */
        public HpSDRFunction<RoyMemberServiceCB, RoyMemberServiceCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RoyMemberServiceCB> sq, RoyMemberServiceCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public RoyMemberServiceCB dreamCruiseCB() {
        RoyMemberServiceCB cb = new RoyMemberServiceCB();
        cb.xsetupForDreamCruise((RoyMemberServiceCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RoyMemberServiceCB> columnQuery(final SpecifyQuery<RoyMemberServiceCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected RoyMemberServiceCB xcreateColumnQueryCB() {
        RoyMemberServiceCB cb = new RoyMemberServiceCB();
        cb.xsetupForColumnQuery((RoyMemberServiceCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RoyMemberServiceCB> orCBLambda) {
        xorSQ((RoyMemberServiceCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RoyMemberServiceCB> andCBLambda) {
        xorSQAP((RoyMemberServiceCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final RoyMemberServiceCB cb;
        if (mainCB != null) {
            cb = (RoyMemberServiceCB)mainCB;
        } else {
            cb = new RoyMemberServiceCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RoyMemberServiceCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RoyMemberServiceCQ.class.getName(); }
