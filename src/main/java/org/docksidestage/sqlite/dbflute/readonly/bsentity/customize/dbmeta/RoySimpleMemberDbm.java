 ...
 */
public class RoySimpleMemberDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final RoySimpleMemberDbm _instance = new RoySimpleMemberDbm();
    private RoySimpleMemberDbm() {}
    public static RoySimpleMemberDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((RoySimpleMember)et).getMemberId(), (et, vl) -> ((RoySimpleMember)et).setMemberId(cti(vl)), "memberId");
        setupEpg(_epgMap, et -> ((RoySimpleMember)et).getMemberName(), (et, vl) -> ((RoySimpleMember)et).setMemberName((String)vl), "memberName");
        setupEpg(_epgMap, et -> ((RoySimpleMember)et).getMemberStatusName(), (et, vl) -> ((RoySimpleMember)et).setMemberStatusName((String)vl), "memberStatusName");
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, null, Integer.class, "memberId", null, false, false, false, "null", 2147483647, 0, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.sqlite.dbflute.readonly.exentity.customize.RoySimpleMember"; }
    ...
    //                                                                         Object Type
    //                                                                         ===========
    public Class<RoySimpleMember> getEntityType() { return RoySimpleMember.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public RoySimpleMember newEntity() { return new RoySimpleMember(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((RoySimpleMember)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((RoySimpleMember)et, mp); }
