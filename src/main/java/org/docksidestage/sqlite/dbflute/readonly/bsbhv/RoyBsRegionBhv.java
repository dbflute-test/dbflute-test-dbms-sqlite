...
public abstract class RoyBsRegionBhv extends AbstractBehaviorReadable<RoyRegion, RoyRegionCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public RoyRegionDbm asDBMeta() { return RoyRegionDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public RoyRegionCB newConditionBean() { return new RoyRegionCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of RoyRegion. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<RoyRegionCB> cbLambda) {
     ...
     * </pre>
     * @param cb The condition-bean of RoyRegion. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(RoyRegionCB cb) {
     ...
     */
    public OptionalEntity<RoyRegion> selectEntity(CBCall<RoyRegionCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<RoyRegion> selectEntity(RoyRegionCB cb) {
        return facadeSelectEntity(cb);
    }

    protected OptionalEntity<RoyRegion> facadeSelectEntity(RoyRegionCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends RoyRegion> OptionalEntity<ENTITY> doSelectOptionalEntity(RoyRegionCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * RoyRegion <span style="color: #553000">region</span> = <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public RoyRegion selectEntityWithDeletedCheck(CBCall<RoyRegionCB> cbLambda) {
     ...
     * RoyRegionCB cb = <span style="color: #70226C">new</span> RoyRegionCB();
     * cb.query().set...;
     * RoyRegion region = <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public RoyRegion selectEntityWithDeletedCheck(RoyRegionCB cb) {
        return facadeSelectEntityWithDeletedCheck(cb);
    }

    /**
     * Select the entity by the primary-key value.
     * @param regionId : PK, NotNull, INTEGER(2000000000, 10). (NotNull)
     * @return The optional entity selected by the PK. (NotNull: if no data, empty entity)
     * @throws EntityAlreadyDeletedException When get(), required() of return value is called and the value is null, which means entity has already been deleted (not found).
     * @throws EntityDuplicatedException When the entity has been duplicated.
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<RoyRegion> selectByPK(Integer regionId) {
        return facadeSelectByPK(regionId);
    }

    protected OptionalEntity<RoyRegion> facadeSelectByPK(Integer regionId) {
        return doSelectOptionalByPK(regionId, typeOfSelectedEntity());
    }

    protected <ENTITY extends RoyRegion> ENTITY doSelectByPK(Integer regionId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(regionId), tp);
    }

    protected <ENTITY extends RoyRegion> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer regionId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(regionId, tp), regionId);
    }

    protected RoyRegionCB xprepareCBAsPK(Integer regionId) {
     ...
     * <pre>
     * ListResultBean&lt;RoyRegion&gt; <span style="color: #553000">regionList</span> = <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (RoyRegion <span style="color: #553000">region</span> : <span style="color: #553000">regionList</span>) {
     *     ... = <span style="color: #553000">region</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of RoyRegion. (NotNull)
     ...
     */
    public ListResultBean<RoyRegion> selectList(CBCall<RoyRegionCB> cbLambda) {
     ...
     * cb.query().set...;
     * cb.query().addOrderBy...;
     * ListResultBean&lt;RoyRegion&gt; <span style="color: #553000">regionList</span> = <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">selectList</span>(cb);
     * <span style="color: #70226C">for</span> (RoyRegion region : <span style="color: #553000">regionList</span>) {
     *     ... = region.get...;
     * }
     * </pre>
     * @param cb The condition-bean of RoyRegion. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public ListResultBean<RoyRegion> selectList(RoyRegionCB cb) {
     ...
     * <pre>
     * PagingResultBean&lt;RoyRegion&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (RoyRegion region : <span style="color: #553000">page</span>) {
     *     ... = region.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of RoyRegion. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<RoyRegion> selectPage(CBCall<RoyRegionCB> cbLambda) {
     ...
     * PagingResultBean&lt;RoyRegion&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">selectPage</span>(cb);
     * <span style="color: #70226C">int</span> allRecordCount = <span style="color: #553000">page</span>.getAllRecordCount();
     * <span style="color: #70226C">int</span> allPageCount = <span style="color: #553000">page</span>.getAllPageCount();
     * <span style="color: #70226C">boolean</span> isExistPrePage = <span style="color: #553000">page</span>.isExistPrePage();
     * <span style="color: #70226C">boolean</span> isExistNextPage = <span style="color: #553000">page</span>.isExistNextPage();
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<RoyRegion> selectPage(RoyRegionCB cb) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of RoyRegion. (NotNull)
     * @param entityLambda The handler of entity row of RoyRegion. (NotNull)
     */
    public void selectCursor(CBCall<RoyRegionCB> cbLambda, EntityRowHandler<RoyRegion> entityLambda) {
     ...
     * </pre>
     * @param cb The condition-bean of RoyRegion. (NotNull)
     * @param entityRowHandler The handler of entity row of RoyRegion. (NotNull)
     */
    public void selectCursor(RoyRegionCB cb, EntityRowHandler<RoyRegion> entityRowHandler) {
     ...
     */
    public <RESULT> HpSLSFunction<RoyRegionCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<RoyRegion> regionList, ReferrerLoaderHandler<RoyLoaderOfRegion> loaderLambda) {
        xassLRArg(regionList, loaderLambda);
        loaderLambda.handle(new RoyLoaderOfRegion().ready(regionList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(RoyRegion region, ReferrerLoaderHandler<RoyLoaderOfRegion> loaderLambda) {
        xassLRArg(region, loaderLambda);
        loaderLambda.handle(new RoyLoaderOfRegion().ready(xnewLRAryLs(region), _behaviorSelector));
    }
     ...
     */
    public NestedReferrerListGateway<RoyMemberAddress> loadMemberAddress(List<RoyRegion> regionList, ReferrerConditionSetupper<RoyMemberAddressCB> refCBLambda) {
        xassLRArg(regionList, refCBLambda);
        return doLoadMemberAddress(regionList, new LoadReferrerOption<RoyMemberAddressCB, RoyMemberAddress>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<RoyMemberAddress> loadMemberAddress(RoyRegion region, ReferrerConditionSetupper<RoyMemberAddressCB> refCBLambda) {
        xassLRArg(region, refCBLambda);
        return doLoadMemberAddress(xnewLRLs(region), new LoadReferrerOption<RoyMemberAddressCB, RoyMemberAddress>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<RoyMemberAddress> doLoadMemberAddress(List<RoyRegion> regionList, LoadReferrerOption<RoyMemberAddressCB, RoyMemberAddress> option) {
     ...
     */
    public List<Integer> extractRegionIdList(List<RoyRegion> regionList)
     ...
     */
    public OutsideSqlAllFacadeExecutor<RoyRegionBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends RoyRegion> typeOfSelectedEntity() { return RoyRegion.class; }
    protected Class<RoyRegion> typeOfHandlingEntity() { return RoyRegion.class; }
    protected Class<RoyRegionCB> typeOfHandlingConditionBean() { return RoyRegionCB.class; }
}
