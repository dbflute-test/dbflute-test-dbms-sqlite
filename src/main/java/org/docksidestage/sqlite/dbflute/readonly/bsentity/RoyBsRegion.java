 ...
 */
public abstract class RoyBsRegion extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof RoyBsRegion) {
            RoyBsRegion other = (RoyBsRegion)obj;
    ...
    @Override
    public RoyRegion clone() {
        return (RoyRegion)super.clone();
    }
