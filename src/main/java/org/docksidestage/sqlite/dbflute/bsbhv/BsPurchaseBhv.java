...
/**
 * The behavior of PURCHASE as TABLE.
...
public abstract class BsPurchaseBhv extends AbstractBehaviorWritable<Purchase, PurchaseCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<Purchase> selectByPK(Integer purchaseId) {
        return facadeSelectByPK(purchaseId);
    }

    protected OptionalEntity<Purchase> facadeSelectByPK(Integer purchaseId) {
        return doSelectOptionalByPK(purchaseId, typeOfSelectedEntity());
    }

    protected <ENTITY extends Purchase> ENTITY doSelectByPK(Integer purchaseId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(purchaseId), tp);
    }

    protected <ENTITY extends Purchase> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer purchaseId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(purchaseId, tp), purchaseId);
    }

    protected PurchaseCB xprepareCBAsPK(Integer purchaseId) {
     ...
     */
    public List<Integer> extractPurchaseIdList(List<Purchase> purchaseList)
    ...
    public void insert(Purchase purchase) {
        InsertOption<PurchaseCB> op = new InsertOption<PurchaseCB>();
        op.xtoBeCompatibleInsertColumnNotNullOnly();
        doInsert(purchase, op);
    }
