...
public abstract class BsSummaryProductBhv extends AbstractBehaviorWritable<SummaryProduct, SummaryProductCB> {
     ...
     */
    public NestedReferrerListGateway<Purchase> loadPurchase(List<SummaryProduct> summaryProductList, ReferrerConditionSetupper<PurchaseCB> refCBLambda) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Purchase> loadPurchase(SummaryProduct summaryProduct, ReferrerConditionSetupper<PurchaseCB> refCBLambda) {
    ...
    public void insert(SummaryProduct summaryProduct) {
        InsertOption<SummaryProductCB> op = new InsertOption<SummaryProductCB>();
        op.xtoBeCompatibleInsertColumnNotNullOnly();
        doInsert(summaryProduct, op);
    }
