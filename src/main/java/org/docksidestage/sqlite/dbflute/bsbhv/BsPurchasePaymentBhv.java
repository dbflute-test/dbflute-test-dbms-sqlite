...
public abstract class BsPurchasePaymentBhv extends AbstractBehaviorWritable<PurchasePayment, PurchasePaymentCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<PurchasePayment> selectByPK(Integer purchasePaymentId) {
        return facadeSelectByPK(purchasePaymentId);
    }

    protected OptionalEntity<PurchasePayment> facadeSelectByPK(Integer purchasePaymentId) {
        return doSelectOptionalByPK(purchasePaymentId, typeOfSelectedEntity());
    }

    protected <ENTITY extends PurchasePayment> ENTITY doSelectByPK(Integer purchasePaymentId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(purchasePaymentId), tp);
    }

    protected <ENTITY extends PurchasePayment> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer purchasePaymentId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(purchasePaymentId, tp), purchasePaymentId);
    }

    protected PurchasePaymentCB xprepareCBAsPK(Integer purchasePaymentId) {
     ...
     */
    public List<Integer> extractPurchasePaymentIdList(List<PurchasePayment> purchasePaymentList)
    ...
    public void insert(PurchasePayment purchasePayment) {
        InsertOption<PurchasePaymentCB> op = new InsertOption<PurchasePaymentCB>();
        op.xtoBeCompatibleInsertColumnNotNullOnly();
        doInsert(purchasePayment, op);
    }
     ...
     * </pre>
     * @param purchasePayment The entity of update. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * <span style="color: #0000C0">purchasePaymentBhv</span>.<span style="color: #CC4747">updateNonstrict</span>(purchasePayment);
     * </pre>
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(PurchasePayment purchasePayment) {
        doUpdateNonstrict(purchasePayment, null);
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdateNonstrict(PurchasePayment purchasePayment) {
        doInsertOrUpdateNonstrict(purchasePayment, null, null);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//purchasePayment.setVersionNo(value);</span>
     * <span style="color: #0000C0">purchasePaymentBhv</span>.<span style="color: #CC4747">deleteNonstrict</span>(purchasePayment);
     * </pre>
     * @param purchasePayment The entity of delete. (NotNull, PrimaryKeyNotNull)
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrict(PurchasePayment purchasePayment) {
        doDeleteNonstrict(purchasePayment, null);
    }
     ...
     * </pre>
     * @param purchasePaymentList The list of the entity. (NotNull, EmptyAllowed, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<PurchasePayment> purchasePaymentList) {
        return doBatchUpdateNonstrict(purchasePaymentList, null);
    }
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDeleteNonstrict(List<PurchasePayment> purchasePaymentList) {
        return doBatchDeleteNonstrict(purchasePaymentList, null);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//purchasePayment.setVersionNo(value);</span>
     * <span style="color: #0000C0">purchasePaymentBhv</span>.<span style="color: #CC4747">varyingUpdateNonstrict</span>(purchasePayment, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">cb</span>.specify().<span style="color: #CC4747">columnXxxCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// XXX_COUNT = XXX_COUNT + 1</span>
     * });
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdateNonstrict(PurchasePayment purchasePayment, WritableOptionCall<PurchasePaymentCB, UpdateOption<PurchasePaymentCB>> opLambda) {
        doUpdateNonstrict(purchasePayment, createUpdateOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdateNonstrict(PurchasePayment purchasePayment, WritableOptionCall<PurchasePaymentCB, InsertOption<PurchasePaymentCB>> insertOpLambda, WritableOptionCall<PurchasePaymentCB, UpdateOption<PurchasePaymentCB>> updateOpLambda) {
        doInsertOrUpdateNonstrict(purchasePayment, createInsertOption(insertOpLambda), createUpdateOption(updateOpLambda));
    }
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDeleteNonstrict(PurchasePayment purchasePayment, WritableOptionCall<PurchasePaymentCB, DeleteOption<PurchasePaymentCB>> opLambda) {
        doDeleteNonstrict(purchasePayment, createDeleteOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdateNonstrict(List<PurchasePayment> purchasePaymentList, WritableOptionCall<PurchasePaymentCB, UpdateOption<PurchasePaymentCB>> opLambda) {
        return doBatchUpdateNonstrict(purchasePaymentList, createUpdateOption(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDeleteNonstrict(List<PurchasePayment> purchasePaymentList, WritableOptionCall<PurchasePaymentCB, DeleteOption<PurchasePaymentCB>> opLambda) {
        return doBatchDeleteNonstrict(purchasePaymentList, createDeleteOption(opLambda));
    }
