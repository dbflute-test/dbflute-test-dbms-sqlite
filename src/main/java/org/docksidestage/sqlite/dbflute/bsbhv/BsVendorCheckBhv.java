...
public abstract class BsVendorCheckBhv extends AbstractBehaviorWritable<VendorCheck, VendorCheckCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<VendorCheck> selectByPK(Integer vendorCheckId) {
        return facadeSelectByPK(vendorCheckId);
    }

    protected OptionalEntity<VendorCheck> facadeSelectByPK(Integer vendorCheckId) {
        return doSelectOptionalByPK(vendorCheckId, typeOfSelectedEntity());
    }

    protected <ENTITY extends VendorCheck> ENTITY doSelectByPK(Integer vendorCheckId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(vendorCheckId), tp);
    }

    protected <ENTITY extends VendorCheck> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer vendorCheckId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(vendorCheckId, tp), vendorCheckId);
    }

    protected VendorCheckCB xprepareCBAsPK(Integer vendorCheckId) {
     ...
     */
    public List<Integer> extractVendorCheckIdList(List<VendorCheck> vendorCheckList)
    ...
    public void insert(VendorCheck vendorCheck) {
        InsertOption<VendorCheckCB> op = new InsertOption<VendorCheckCB>();
        op.xtoBeCompatibleInsertColumnNotNullOnly();
        doInsert(vendorCheck, op);
    }
